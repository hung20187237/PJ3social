                    ...
                    <div className="reviewRight">
                        <form className="reviewBox">
                            ...
                            <input
                                ...
                                ref={place}
                            />
                            <input className="reviewInput" list="Country" placeholder=" Khu Vực" ref={tagkv} />
                            <datalist id="Country">
                            ...
                            <input className="reviewInput" list="Tieuchi" placeholder=" Tiêu Chí" ref={tagtc} />
                            <datalist id="Tieuchi">
                                <option value="Hẹn hò" />
                            ...
                            <input className="reviewInput" list="Danhmuc" placeholder=" Danh mục" ref={tagdm} />
                            <datalist id="Danhmuc">
